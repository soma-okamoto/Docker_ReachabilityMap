...
print("PyTorch CUDA 対応ビルドか:", torch.version.cuda)            # 例: '11.8' など
print("cuda.is_available():", torch.cuda.is_available())         # True になれば OK
print("GPU の数:", torch.cuda.device_count())                    # 利用可能な GPU 数
if torch.cuda.is_available():
    print("GPU[0] の名称:", torch.cuda.get_device_name(0))
