...
for roll in roll_values:
    for pitch in pitch_values:
        for yaw in yaw_values:
            ...
            goal_pose = torch.tensor([ x, y , z , yaw, pitch, roll])
...
base_map_file_name = '3base_' + inv_reach_map_file_name
...
with h5py.File(inv_reach_map_file_path + "5_pkl_" + base_map_file_name + ".h5", 'w') as f:
...
print(f"[Saved file: 5_pkl_{base_map_file_name}.h5 ]")
