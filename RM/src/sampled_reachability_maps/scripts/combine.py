...
# M_scoreの高いポイントを抽出（例: 上位1%を抽出）
score_threshold = np.percentile(overlap_scores.numpy(), 99.99)  # 上位1%を抽出
...
# high_score_pointsには、M_scoreが上位0.1%の座標が含まれています
print("Top 0.1% points:")
print(high_score_points)
...
output_hdf5 = "/home/dasnote11/catkin_ws/src/sampled_reachability_maps/data/high_score_overlap_map_1percent.h5"
