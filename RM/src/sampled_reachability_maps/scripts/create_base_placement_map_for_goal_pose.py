...
cartesian_res = 50.08# metres
Q_scaling = 100

# Full path and file name to save
parser = argparse.ArgumentParser("create base map")
parser.add_argument("--inv_map_pkl", type=str, required=True, help="/home/dasnote11/catkin_ws/src/sampled_reachability_maps/maps/reach_map_lbr_iiwa_link_7_torso_False_0.08_2024-12-19-00-45-23.pklinv_reach_map_lbr_iiwa_link_7_torso_False_0.08_2024-12-19-00-45-23.pkl")
