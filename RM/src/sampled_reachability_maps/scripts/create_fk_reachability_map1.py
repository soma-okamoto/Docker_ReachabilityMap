...
joint_pos_min = torch.tensor([-2.9, -2.09, -2.96, -2.09, -2.96, -2.09, -2.96], dtype=dtype, device=d)
joint_pos_max = torch.tensor([+2.9, +2.09, +2.96, +2.09, +2.96, +2.09, +2.96], dtype=dtype, device=d)
#################################################################################
#joint_pos_min = torch.tensor([-1.9, -1.09, -1.96, -1.09, -1.96, -1.09, -1.96], dtype=dtype, device=d)
#joint_pos_max = torch.tensor([+1.9, +1.09, +1.96, +1.09, +1.96, +1.09, +1.96], dtype=dtype, device=d)
...
x_lim = [-1.0, 1.0] #[-1.0, 1.0] # min,max in metres (Set these as per your robot links)
y_lim = [-0.4, 1.15]#[-0.4, 1.15]
z_lim = [-0.15, 1.9]#[-0.15, 1.9]
