...
#####################################################################
cartesian_res = 5 # metres 0.05　変更したのここだけ
...
reach_map_file_path = '/home/dasnote11/catkin_ws/src/sampled_reachability_maps/data/reach_map_gripper_finger_link_torso_True_0.08_2024-12-20-23-07-48.pkl'
...
print(f"[Saved file: {inv_reach_map_file_name} ]") #####このファイルである地点での訪問頻度を示している
